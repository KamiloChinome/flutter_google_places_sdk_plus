...
String placeFieldToApiName(inter.PlaceField field) {
  return switch (field) {
    ...
    inter.PlaceField.ReviewSummary => 'reviews',
    inter.PlaceField.NeighborhoodSummary => 'areaInfo',
    inter.PlaceField.EvChargeAmenitySummary => 'evChargeOptions',
    inter.PlaceField.ConsumerAlerts => 'formattedAddress',
